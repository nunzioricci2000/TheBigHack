...
public class BoardHeaderCell: BaseTableViewCell {
    ...
    public override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        let titleTextStackView = UIStackView.getVerticalStackView(withSpacing: 10.0,
                                                                views: [
                                                                    titleLabel,
                                                                    subtitleLabel
                                                                ])
        ...
        titleTextStackView.setDimensionContraints(height: 60.0)
        ...
        let divisor = UIView()
        divisor.backgroundColor = UIColor.systemGray5
