...
extension AccelerationEventPresenter: AccelerationEventDelegate {
    ...
    func getSupportedEvents() -> [AccelerationEventCommand]? {
        ...
        case .sensorTileBox, .sensorTileBoxPro:
            return AccelerationEventPresenter.SENSORTILEBOX_SUPPORTED_EVENT
        case .stEvalSTWINKIT1, .stEvalSTWINKT1B, .stWinBox:
    ...
    func getDefaultEvent() -> AccelerationEventCommand {
        ...
        case .sensorTile, .blueCoin, .wbBoard, .wbaBoard, .nucleo, .nucleoF401RE, .nucleoF446RE, .nucleoL053R8, .nucleoL476RG, .sensorTileBox, .sensorTileBoxPro, .stEvalSTWINKIT1, .stEvalSTWINKT1B, .stWinBox:
