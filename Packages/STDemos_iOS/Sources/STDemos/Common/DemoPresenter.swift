...
public class DemoPresenter<T: Presentable>: DemoBasePresenter<T, Void> {
}

public class DemoBasePresenter<T: Presentable, M>: BasePresenter<T, DemoParam<M>>, DemoDelegate {
    ...
    public func viewWillAppear() {
        ...
        if let analytics: AnalyticsService = Resolver.shared.resolve(),
           let demo = demo {
            analytics.startDemo(withName: demo.description)
        }
    ...
    public func viewWillDisappear() {
        ...
        if let analytics: AnalyticsService = Resolver.shared.resolve(),
           let demo = demo {
            analytics.stopDemo(withName: demo.description)
        }
