...
final class JsonNfcView: UIView {
    ...
    override func awakeFromNib() {
        ...
        textWriteBtn.setTitle(Localizer.JsonNfc.Action.writeToNfc.localized, for: .normal)
        ...
        urlWriteBtn.setTitle(Localizer.JsonNfc.Action.writeToNfc.localized, for: .normal)
        ...
        wifiWriteBtn.setTitle(Localizer.JsonNfc.Action.writeToNfc.localized, for: .normal)
        ...
        vcardWriteBtn.setTitle(Localizer.JsonNfc.Action.writeToNfc.localized, for: .normal)
    }
