           ...
           let data = sample.data {
            ...
            if let prob1Value = prob1Value {
                ...
                if mostProbableClassValue == 1 {
                    self.view.probability1Label.textColor = .red
                } else {
                    self.view.probability1Label.textColor = .black
                }
            } else {
            ...
            if let prob2Value = prob2Value {
                ...
                if mostProbableClassValue == 2 {
                    self.view.probability2Label.textColor = .red
                } else {
                    self.view.probability2Label.textColor = .black
                }
            } else {
            ...
            if let prob3Value = prob3Value {
                ...
                if mostProbableClassValue == 3 {
                    self.view.probability3Label.textColor = .red
                } else {
                    self.view.probability3Label.textColor = .black
                }
            } else {
            ...
            if let prob4Value = prob4Value {
                ...
                if mostProbableClassValue == 4 {
                    self.view.probability4Label.textColor = .red
                } else {
                    self.view.probability4Label.textColor = .black
                }
            } else {
            ...
            if let prob5Value = prob5Value {
                ...
                if mostProbableClassValue == 5 {
                    self.view.probability5Label.textColor = .red
                } else {
                    self.view.probability5Label.textColor = .black
                }
            } else {
            ...
            if let prob6Value = prob6Value {
                ...
                if mostProbableClassValue == 6 {
                    self.view.probability6Label.textColor = .red
                } else {
                    self.view.probability6Label.textColor = .black
                }
            } else {
            ...
            if let prob7Value = prob7Value {
                ...
                if mostProbableClassValue == 7 {
                    self.view.probability7Label.textColor = .red
                } else {
                    self.view.probability7Label.textColor = .black
                }
            } else {
            ...
            if let prob8Value = prob8Value {
                ...
                if mostProbableClassValue == 8 {
                    self.view.probability8Label.textColor = .red
                } else {
                    self.view.probability8Label.textColor = .black
                }
            } else {
